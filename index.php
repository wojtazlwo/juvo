...
<html lang="en">
  <head>
    ...
    <!-- w razie gdy będzie potrzebny bootstrap
  ...
  <body>
    <header>
      <nav>
        <!-- Tu będzie belka nawigacyjna. Chciałbym, aby belka podążała za użytkownikiem, lub żeby pojawiała się dopiero przy ponownym podjechaniu w górę -->
      </nav>
    ...
    <!-- jQuery, Popper.js, Bootstrap JS lokalnie, także w razie potrzeby bootstrapa
